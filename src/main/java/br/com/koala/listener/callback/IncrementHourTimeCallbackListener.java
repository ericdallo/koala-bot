...
@Component
class IncrementHourTimeCallbackListener extends TimeCallbackListener {

	@Autowired
	IncrementHourTimeCallbackListener(TelegramBot bot) {
		super(bot);
	}
	...
	boolean timeMatch(String action) {
		return action.startsWith(SimpleTimeKeyboard.UP_HOUR);
	}
}
